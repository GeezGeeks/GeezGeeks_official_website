      ...
      <div className="w-1/2 h-full flex items-center justify-center max-[960px]:w-full max-[960px]:order-2 max-[960px]:my-12 max-[560px]:my-20">
        <div className="max-[960px]:text-center">
          <h1 className="font-extrabold text-5xl md:text-6xl text-slate-800 dark mb-6 leading-tight transition-colors duration-300 header-text">
            <span className="stroke-text">We Craft</span> Digital Experiences
            That Inspire And Connect.
          </h1>
          <p className="max-w-xl mr-5 py-4 pb-10 leading-7 text-base font-semibold text-slate-600 dark:text-slate-600 max-[960px]:max-w-full max-[960px]:text-center">
            At GeezGeeks, we fuse design with technology to build websites,
            brands, and solutions that speak your story loud and clear. Our
            expert team specializes in web development, design, and digital
            marketing to help your business grow online.
          </p>
      ...
      <div className="w-1/2 h-full relative max-[960px]:w-full max-[960px]:order-1 max-[960px]:mt-8">
        <div className="flex justify-end relative z-10 max-[960px]:justify-center">
          ...
          <div className="absolute left-0 bottom-12 max-w-md p-8 flex items-center bg-white rounded-2xl shadow-lg z-20 max-[960px]:left-5 max-[560px]:bottom-[-50px] transition-colors duration-300">
            ...
            <div>
              <blockquote className="text-base text-slate-700 italic mb-2 transition-colors duration-300">
                Friends, such as we desire, are dreams and fables. Friendship
                demands the ability to do without it.
              </blockquote>
              <cite className="text-sm text-cyan-600 text-right mt-2 transition-colors duration-300 block">
                Ralph Waldo Emerson
              </cite>
            </div>
          </div>
